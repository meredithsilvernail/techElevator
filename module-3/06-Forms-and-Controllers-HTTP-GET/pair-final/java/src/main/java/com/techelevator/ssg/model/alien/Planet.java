...
public enum Planet {
	...
	MERCURY("Mercury", 87.96, 0.37, 56_974_146L), VENUS("Venus", 224.68, 0.90, 25_724_767L),
	MARS("Mars", 686.98, 0.38, 48_678_219L), JUPITER("Jupiter", 4329.63, 2.65, 390_674_710L),
	SATURN("Saturn", 10751.44, 1.13, 792_248_270L), URANUS("Uranus", 30685.55, 1.09, 1_692_662_530L),
